...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/simulate-iter-triangle-wave/tags). For example,

```javascript
iterTriangleWave = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-triangle-wave@v0.2.3-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterTriangleWave = require( 'path/to/vendor/umd/simulate-iter-triangle-wave/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/simulate-iter-triangle-wave/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/simulate-iter-triangle-wave/actions/workflows/test.yml?query=branch:v0.2.3
...
[deno-readme]: https://github.com/stdlib-js/simulate-iter-triangle-wave/blob/deno/README.md
...
[esm-readme]: https://github.com/stdlib-js/simulate-iter-triangle-wave/blob/esm/README.md
